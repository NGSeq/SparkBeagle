...
public final class VcfHeader  {
    ...
    private final FSDataInputStream file;   // null if source is standard input
    ...
    public VcfHeader(FileIt<String> it, Filter<String> sampleFilter) {
        ...
        //System.out.println(candidateHeader);
    ...
    private static void checkHeaderLine(String line, FSDataInputStream file) {
