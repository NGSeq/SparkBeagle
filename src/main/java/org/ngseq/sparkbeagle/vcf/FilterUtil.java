...
public final class FilterUtil {
     ...
     */
    public static Filter<Marker> markerFilter(FSDataInputStream excludeMarkersFile) {
     ...
     * more white-space characters
     */
    public static Filter<String> sampleFilter(FSDataInputStream excludeSamplesFile) {
